...
namespace BCR耐電圧_絶縁抵抗試験
{
    public static class Constants
    {
        ...
        public const string Pc7LogFileFolder = @"\\Y01130003\bc-r_data\BCR_PC7\Log_AUR\";//Q890A100(サブベースユニット)の誤配線チェック結果があります

        public const string Aur_Pc3LogFileFolder = @"\\Y01130003\bc-r_data\AUR_PC3\Log\";
        public const string Aur_Pc4LogFileFolder = @"\\Y01130003\bc-r_data\AUR_PC4\Log\";

        public const string 日常点検FolderPath = @"C:\BCR耐電圧・絶縁抵抗試験\日常点検\";

        public const string 検査ﾃﾞｰﾀBcrFolderPath = @"C:\BCR耐電圧・絶縁抵抗試験\検査データ\";

        public const string fileName_FormatLog =  @"C:\BCR耐電圧・絶縁抵抗試験\FormatLog.txt";
        ...
        public const string SetQ890Path = @"C:\BCR耐電圧・絶縁抵抗試験\SetQ890.bmp";
